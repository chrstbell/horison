...
@section("content")
    <div class="header-section">
        ...
        <div class="breadcrumb">
            <a onclick="goToDashboard()">Dashboard</a> > New Menu
        </div>
        <button class="add-menu-btn" type="button">
            ...
            <a style="text-decoration: none; color: inherit;" href="{{ route("admin.tambah_menu") }}?from=new-menu">Tambah
                Daftar Menu</a>
        </button>
    </div>
    ...
    <div class="category-nav">
        ...
        <button class="nav-item active" onclick="switchMenuCategory('makanan', this)" data-category="makanan">
            Makanan
        </button>
        <button class="nav-item" onclick="switchMenuCategory('minuman', this)" data-category="minuman">
            Minuman
        </button>
    </div>
    ...
    <div class="content-section">
        <h2 class="section-title" id="sectionTitle">Makanan</h2>
...
@push("scripts")
    <script>
        // Variabel global untuk menyimpan data item yang akan diubah statusnya
        let pendingToggleItem = null;
        ...
        function loadMenuData(category) {
            ...
            fetch(`/admin/menu/filter/new_menu/${category}`)
