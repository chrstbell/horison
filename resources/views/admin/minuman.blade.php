...
@section("content")
    <div class="header-section">
        ...
        <div class="breadcrumb">
            <a onclick="goToDashboard()">Dashboard</a> > Minuman
        </div>
        <button class="add-menu-btn" type="button">
            ...
            <a style="text-decoration: none; color: inherit;" href="{{ route("admin.tambah_menu") }}?from=minuman">Tambah
                Daftar Menu</a>
        </button>
    </div>
    ...
    <div class="category-nav">
        ...
        <button class="nav-item active" onclick="switchMenuCategory('mocktail', this)" data-category="mocktail">
            Mocktail
        </button>
        <button class="nav-item" onclick="switchMenuCategory('milkhouse', this)" data-category="milkhouse">
            Milk House
        </button>
        <button class="nav-item" onclick="switchMenuCategory('squash', this)" data-category="squash">
            Squash
        </button>
        <button class="nav-item" onclick="switchMenuCategory('juices', this)" data-category="juices">
            Juices
        </button>
        <button class="nav-item" onclick="switchMenuCategory('softdrink', this)" data-category="softdrink">
            Soft Drink
        </button>
        <button class="nav-item" onclick="switchMenuCategory('coffee-tea', this)" data-category="coffee-tea">
            Coffee, Traditional & Tea
        </button>
    </div>

    <!-- Content Section -->
    <div class="content-section">
        <h2 class="section-title" id="sectionTitle">Mocktail</h2>
    ...
    <div id="confirmationModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="modal-button cancel-button" onclick="closeConfirmationModal()">Batal</button>
...
@push("scripts")
    <script>
        function switchMenuCategory(category, element) {
            ...
            const titles = {
                'mocktail': 'Mocktail',
                'milkhouse': 'Milk House',
                'squash': 'Squash',
                'juices': 'Juices',
                'softdrink': 'Soft Drink',
                'coffee-tea': 'Coffee, Traditional & Tea'
            };
        ...
        function loadMenuData(category) {
            ...
            fetch(`/admin/menu/filter/minuman/${category}`)
